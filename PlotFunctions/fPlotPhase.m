...
%  sPhase   :: Which phase data to plot
%
%  Options:
% ==========
%  HLim        :: Horizontal axis limits in mm or MeV
%  VLim        :: Vertical axis limits in mm or MeV
%  HAuto       :: Autoscale horizontal axis
%  VAuto       :: Autoscale vertical axis
%  FlipAxis    :: Swap horizontal and vertical axis
...
function stReturn = fPlotPhase(oData, sTime, sSpecies, sPhase, varargin)
    ...
    if nargin == 0
        ...
        fprintf('  sPhase   :: Which phase data to plot\n');
        fprintf('\n');
        fprintf('  Options:\n');
        fprintf(' ==========\n');
        fprintf('  HLim        :: Horizontal axis limits in mm or MeV\n');
        fprintf('  VLim        :: Vertical axis limits in mm or MeV\n');
        fprintf('  HAuto       :: Autoscale horizontal axis\n');
        fprintf('  VAuto       :: Autoscale vertical axis\n');
        fprintf('  FlipAxis    :: Swap horizontal and vertical axis\n';
